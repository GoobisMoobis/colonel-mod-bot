...
class ModeratedBot(commands.Bot):
    ...
    def setup_automod_patterns(self):
        ...
        raw_patterns = [
            # R slur
            r"(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+\s*(e|3|£|🇪|е|ҽ|ꬲ|🅔|𝕰)?+\s*(t|7|🇹|✝️|🅣|𝗍|𝕿)+\s*(a|4|@|∆|/-\\|/_\\|Д|🇦|🅰️|ɑ|а|🅐|𝖺|𝕬)?+\s*(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+\s*(d|🇩|ԁ|Ꮷ|ᑯ|ꓒ|🅓|ძ|𝖽|𝕯)+",
            r"(d|🇩|ԁ|Ꮷ|ᑯ|ꓒ|🅓|ძ|𝖽|𝕯)+\s*(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+\s*(a|4|@|∆|/-\\|/_\\|Д|🇦|🅰️|ɑ|а|🅐|𝖺|𝕬)?+\s*(t|7|🇹|✝️|🅣|𝗍|𝕿)+\s*(e|3|£|🇪|е|ҽ|ꬲ|🅔|𝕰)?+\s*(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+",
            # N slur
            r"(n|\|\\||🇳|ո|ռ|🅝|𝕹)+\s*(i|1|!|\||l|🇮|ℹ️|ı|ɩ|ɪ|ӏ|Ꭵ|ꙇ|ꭵ|ǀ|Ι|І|Ӏ|׀|ו|ן|١|۱|ا|Ⲓ|ⵏ|ꓲ|𐊊|𐌉|𐌠|𖼨|ﺍ|ﺎ|￨|🅘|𝕴)?+\s*(g|9|🇬|ƍ|ɡ|ᶃ|🅖|𝕲){2,}\s*(e|3|£|🇪|е|ҽ|ꬲ|🅔|𝕰)?+\s*(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+",
            r"(n|\|\\||🇳|ո|ռ|🅝|𝕹)+\s*(i|1|!|\||l|🇮|ℹ️|ı|ɩ|ɪ|ӏ|Ꭵ|ꙇ|ꭵ|ǀ|Ι|І|Ӏ|׀|ו|ן|١|۱|ا|Ⲓ|ⵏ|ꓲ|𐊊|𐌉|𐌠|𖼨|ﺍ|ﺎ|￨|🅘|𝕴)?+\s*(g|9|🇬|ƍ|ɡ|ᶃ|🅖|𝕲){2,}\s*(a|4|@|∆|/-\\|/_\\|Д|🇦|🅰️|ɑ|а|🅐|𝖺|𝕬)?+",
            r"(a|4|@|∆|/-\\|/_\\|Д|🇦|🅰️|ɑ|а|🅐|𝖺|𝕬)?+\s*(g|9|🇬|ƍ|ɡ|ᶃ|🅖|𝕲){2,}\s*(i|1|!|\||l|🇮|ℹ️|ı|ɩ|ɪ|ӏ|Ꭵ|ꙇ|ꭵ|ǀ|Ι|І|Ӏ|׀|ו|ן|١|۱|ا|Ⲓ|ⵏ|ꓲ|𐊊|𐌉|𐌠|𖼨|ﺍ|ﺎ|￨|🅘|𝕴)?+\s*(n|\|\\||🇳|ո|ռ|🅝|𝕹)+",
            r"(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+\s*(e|3|£|🇪|е|ҽ|ꬲ|🅔|𝕰)?+\s*(g|9|🇬|ƍ|ɡ|ᶃ|🅖|𝕲){2,}\s*(i|1|!|\||l|🇮|ℹ️|ı|ɩ|ɪ|ӏ|Ꭵ|ꙇ|ꭵ|ǀ|Ι|І|Ӏ|׀|ו|ן|١|۱|ا|Ⲓ|ⵏ|ꓲ|𐊊|𐌉|𐌠|𖼨|ﺍ|ﺎ|￨|🅘|𝕴)?+\s*(n|\|\\||🇳|ո|ռ|🅝|𝕹)+",
            r"(n|\|\\||🇳|ո|ռ|🅝|𝕹)+\s*(i|1|!|\||l|🇮|ℹ️|ı|ɩ|ɪ|ӏ|Ꭵ|ꙇ|ꭵ|ǀ|Ι|І|Ӏ|׀|ו|ן|١|۱|ا|Ⲓ|ⵏ|ꓲ|𐊊|𐌉|𐌠|𖼨|ﺍ|ﺎ|￨|🅘|𝕴)?+\s*(g|9|🇬|ƍ|ɡ|ᶃ|🅖|𝕲)+\s*(a|4|@|∆|/-\\|/_\\|Д|🇦|🅰️|ɑ|а|🅐|𝖺|𝕬)?+",
            r"(n|\|\\||🇳|ո|ռ|🅝|𝕹)+\s*(i|1|!|\||l|🇮|ℹ️|ı|ɩ|ɪ|ӏ|Ꭵ|ꙇ|ꭵ|ǀ|Ι|І|Ӏ|׀|ו|ן|١|۱|ا|Ⲓ|ⵏ|ꓲ|𐊊|𐌉|𐌠|𖼨|ﺍ|ﺎ|￨|🅘|𝕴)?+\s*(g|9|🇬|ƍ|ɡ|ᶃ|🅖|𝕲)+\s*(r|🇷|®️|г|ᴦ|ⲅ|ꭇ|ꭈ|ꮁ|🅡|𝕽)+"
        ]
        self.regex_patterns = [
